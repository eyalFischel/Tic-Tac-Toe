...
#### Feel free to play with it locally (port 8000) or use the API from https://www.tictractoe.com/help , You can also use : https://www.tictractoe.com/docs (from my private server)